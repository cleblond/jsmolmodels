/* $Author: hansonr $
* $Date: 2024-08-06 08:08:14 -0500 (Tue, 06 Aug 2024) $
* $Revision: 22629 $
*
...
//    }
  ...
  private int checkSpecialParameterSyntax() {
    ...
    if (lookingAtDecimal()) {
      ...
      int intValue = (Edge.getFloatEncodedInt(script.substring(ichToken,
          ichToken + cchToken)));
  ...
  private Float lookingAtExponential() {
    ...
    if (!isOK)
      return null;
    cchToken = ichT - ichToken;
    return Float.valueOf((float) PT.dVal(script.substring(pt0, ichT)));
  }
