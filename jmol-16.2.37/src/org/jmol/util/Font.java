/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2024-07-23 19:27:28 -0500 (Tue, 23 Jul 2024) $
 * $Revision: 22627 $
 *
...
final public class Font {
  ...
  private Font(FontManager manager, int fid, int idFontFace,
      int idFontStyle, float fontSize, float fontSizeNominal, float fontSizeAngstroms, Object graphics) {
