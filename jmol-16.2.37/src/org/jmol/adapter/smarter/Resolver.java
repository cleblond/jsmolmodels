/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2024-08-15 08:50:13 -0500 (Thu, 15 Aug 2024) $
 * $Revision: 22630 $
 *
...
//      readerName = "Xml";
  ...
  private static byte[] cdxMagic = new byte[] { 0+'V', 0+'j', 0+'C', 0+'D' };
  
  private static byte[] cmdfMagic = new byte[] { 0+'C', 0+'M', 0+'D', 0+'F' };

  private static byte[] mmtfMagic = new byte[] { 0+'m', 0+'m', 0+'t', 0+'f' };

  // various flavors of BCIF file format

  private static byte[] bcifMolstarMagic = new byte[] { 0+'m', 0+'o', 0+'l', 0+'*' };

  private static byte[] bcifDensityMagic = new byte[] { 0+'D', 0+'e', 0+'n', 0+'s' };

  private static byte[] bcifVolumeMagic = new byte[] { 0+'V', 0+'o', 0+'l', 0+'u' };

  private static byte[] bcifModelMagic = new byte[] { 0+'M', 0+'o', 0+'d', 0+'e' };

  private static byte[] bcifCoordMagic = new byte[] { 0+'C', 0+'o', 0+'o', 0+'r', 0+'d'};

  private static byte[] bcifServerMagic = new byte[] { 0+'S', 0+'E', 0+'R', 0+'V', 0+'E', 0+'R'};
