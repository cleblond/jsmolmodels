...
class PyMOL {
  ...
  static P3 getDefaultSettingPt(int i, int pymolVersion, P3 pt) {
    switch (i) {
    case label_position:
      pt.set(0,  0,  1.75f); // was 0.75, but that does not work in PyMOL or Jmol -- just dead center.
      break;
    default:
...
//};
   ...
   */
  static float[] fixAllZeroLabelPosition(float[] labelPos) {
    for (int i = 0; i < 7; i++) {
      if (labelPos[i] != 0)
        return labelPos;
    }
