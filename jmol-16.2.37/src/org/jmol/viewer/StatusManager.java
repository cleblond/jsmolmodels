/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2024-09-03 12:14:46 -0500 (Tue, 03 Sep 2024) $
 * $Revision: 22631 $
 *
...
////////////////////Jmol status //////////////
  ...
  synchronized void setStatusObjectHovered(String id, String strInfo, T3 pt) {
    ...
    if (isEnabled || sJmol != null)
      fireJmolScriptCallback(isEnabled, CBK.HOVER, 
          new Object[] {sJmol, strInfo, Integer.valueOf(-1), id, Float.valueOf(pt.x), Float.valueOf(pt.y), Float.valueOf(pt.z) }, true);
  }
      ...
      fireJmolScriptCallback(isEnabled, CBK.ANIMFRAME,
          new Object[] {
              ...
              new int[] { frameNo, fileNo, modelNo, firstNo, lastNo,
                  currentFrame }, entryName, Float.valueOf(currentMorphModel) }, false);
    ...
    if (isEnabled || sJmol != null)
      fireJmolScriptCallback(isEnabled, CBK.DRAGDROP,
          new Object[] { sJmol, Integer.valueOf(mode), Integer.valueOf(x),
              Integer.valueOf(y), fileName, retType }, true);
    return isEnabled;
  }
  ...
  synchronized void setStatusMeasuring(String status, int intInfo, String strMeasure, float value) {
    ...
    if (isEnabled || sJmol != null)
      fireJmolScriptCallback(isEnabled, CBK.MEASURE,
          new Object[] { sJmol, strMeasure,  Integer.valueOf(intInfo), status , Float.valueOf(value)}, true);
  }
  ...
  synchronized void setSync(String mouseCommand) {
    if (syncingMouse) {
      ...
      syncSend("!" + vwr.tm.getMoveToText(minSyncRepeatMs / 1000f, false), "*",
          0);
  }
